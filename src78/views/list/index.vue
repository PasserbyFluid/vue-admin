...
export default {
  ...
  methods: {
		...
		import('@/utils/Export2Excel').then(excel => {
			const tHeader = ['订单编号','定稿日期', '客户归属','客户来源', '客户', '聊天旺旺','付款旺旺', '卡名', '工艺','数量', '单价', '版费', '加急费', '收金额','实际到账金额','定金', '余款', '旺付款方式旺', '拍款日期', '车间','单价', '版费', '加急费', '卡款出', '利润','刷卡器', '系统', '邮费', '金属标签', '发票类型','发票', '退款', '旺旺', '总支出', '纯利']
			const filterVal = ['ordercode','dingdate','belong', 'source', 'kehu', 'aliwwliao','aliwwfu', 'gy','count','price', 'banfei', 'jiaji', 'shoumoney','realshoumoney', 'dingmoney','shengmoney','payment', 'paytime', 'chejian', 'price1', 'banfei1','jiaji1','kakuan', 'lirun', 'shuakaqi', 'system', 'youfei','label','fapiao', 'tuikuan', 'zhichu', 'chunli']
