				...
				<el-row :gutter="20">
					<el-col :span="4">
						<el-form-item label=""  label-width='0' prop="jine">
							<el-input v-model="ruleForm.jine" placeholder="支出金额" ></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="4">
					...
					<el-col :span="4">
						<el-form-item label=""  label-width='0' prop="type">
							<el-select v-model="ruleForm.type" placeholder="支出类型">
							<el-option label="区域一" value="shanghai"></el-option>
							<el-option label="区域二" value="beijing"></el-option>
							</el-select>
						</el-form-item>
	...
	data() {
		return {
			...
			rules: {
				...
				payment: [
				{ required: true, message: "请选支付方式", trigger: "change" }
				],
				type: [{ required: true, message: "请填写支出类型", trigger: "blur" }]
			},
			tableData: [],
			isShowBeizhu:false,
			query:{
